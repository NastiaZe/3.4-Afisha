...
public class MovieRepositoryTest {
    ...
    private final PurchaseItem first = new PurchaseItem(1, 1, "url1", "name1", "genre1", 6);
    private final PurchaseItem second = new PurchaseItem(2, 2, "url2", "name2", "genre2", 12);
    private final PurchaseItem third = new PurchaseItem(3, 3, "url3", "name3", "genre3", 18);
